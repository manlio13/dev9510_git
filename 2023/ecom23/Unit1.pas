...
procedure TForm1.Button8Click(Sender: TObject);     //Backup
   var
   dir:string;
   dirList:TStringList;      //occorre creare un StringList perch� JVshFileOperation non accetta altro che da StingList
begin
...
begin
 ...
 then salta :=True;
  ...
  if (clnu = 2)or (clnu=5) then
   ...
   end; {else              // righe di codice eliminate perch� bloccavano la dbgrid quando
       if clnu=1 then      // si cliccava sul campo prodotto cio� clnu=1
     begin
       DBGrid1.SetFocus;
